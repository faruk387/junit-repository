...
//        Click all the buttons
        ...
        actions.pause(Duration.ofSeconds(1)).contextClick(oncontextmenu).pause(Duration.ofSeconds(1)).doubleClick(ondoubleclick).pause(Duration.ofSeconds(1)).click(onfocus)
                ...
                .pause(Duration.ofSeconds(1)).click(onmousedown).pause(Duration.ofSeconds(1))
                .pause(Duration.ofSeconds(1)).click(onmousedown).perform();
